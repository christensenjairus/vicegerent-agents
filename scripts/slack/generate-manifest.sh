...
#                The slash command is derived by lowercasing and replacing spaces with hyphens.
#   output-file  Where to write the manifest (default: stdout)
#
# Examples:
#   ./generate-manifest.sh "Hermes Infra"
#   ./generate-manifest.sh "Hermes Infra" infra-manifest.yaml
#   ./generate-manifest.sh Hermes > hermes-manifest.yaml
...
# Derive slash command: lowercase, spaces → hyphens, strip leading slash if provided
