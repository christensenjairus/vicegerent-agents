module github.com/jchristensen/vicegerent-agents/images/mcp-cerbos-shim
...
require (
	...
	github.com/bufbuild/protovalidate-go v0.3.1 // indirect
	github.com/cerbos/cerbos/api/genpb v0.0.0-20230925081347-341baa486365 // indirect
